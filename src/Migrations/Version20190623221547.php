 ...
 */
final class Version20190623221547 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE userrel_id user_rel_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE user_rel_id UserRel_id INT NOT NULL');
